...
autocmd BufRead,BufNewFile *.fs,*.hs,*.ml,*.mli,*.mll,*.mly setlocal tabstop=4 softtabstop=1 shiftwidth=4 expandtab smarttab autoindent
...
autocmd BufRead,BufNewFile *.ml,*.mli,*.mll,*.mly set filetype=ocaml
